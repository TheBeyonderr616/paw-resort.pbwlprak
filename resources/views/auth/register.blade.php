...
<style>
    ...
    .auth-title { font-size:1.1rem; font-weight:700; color:var(--paw-teal); margin-bottom:4px; }
    .auth-brand { font-family:'Baloo 2',cursive; font-size:2.2rem; font-weight:800; color:var(--paw-brown); line-height:1; margin-bottom:4px; }
    .auth-tagline { font-size:0.95rem; font-weight:700; color:var(--paw-teal); margin-bottom:20px; }
    .auth-pet-img { font-size:90px; display:block; margin:0 auto 10px; animation:float 3s ease-in-out infinite; }
    .auth-form-box { background:#ffffffcc; border-radius:24px; padding:28px 24px; border:2px solid var(--paw-border); backdrop-filter:blur(8px); }
    .input-group-paw { position:relative; margin-bottom:14px; }
    .input-group-paw .input-icon { position:absolute; left:16px; top:50%; transform:translateY(-50%); color:#aaa; font-size:0.9rem; }
    .input-group-paw input { padding-left:42px !important; }
    .auth-link { font-size:0.85rem; font-weight:700; color:var(--paw-dark); margin-top:12px; }
